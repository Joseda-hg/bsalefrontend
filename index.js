...
//Funcion para generar Bootstrap cards recibiendo como items un objeto JSON con caracteristicas predefinidas por la base de datos
...
//   Imagen para aquellos que no posean una disponible
  else {
    image.src =
...
// Llamada inicial para para generar las cards con todos los productos recibidos de ls BD inicialmente
...
//Llamada para generar las cards en base a los resultados de la busqueda
//recibe un array de items, provinientes de Search()
//Limpia los resultados iniciales del primer fetch
// TODO renombrar la funcion a algo mas generico, ya que la usan metodos no relacionados a la busqueda
...
// Determina los resultados de busqueda y llama la funcion para renderizarlos
...
// fetch categorias, recibe datos de un selector con id catefories
...
// Alert para cada click en los botones de agregar carrito
function addToCart() {
